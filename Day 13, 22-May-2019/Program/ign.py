# -*- coding: utf-8 -*-
"""
Created on Fri May 24 11:06:53 2019
...
ign = pd.read_csv('material/ign.csv')

# find games released for the Xbox One that have a score of more than 7.
   
task1 = ign['title'][(ign['platform'] == 'Xbox One') & (ign['score'] > 7)]
...
ign[ign['platform'] == 'Xbox One']['score'].plot(kind = 'hist')
